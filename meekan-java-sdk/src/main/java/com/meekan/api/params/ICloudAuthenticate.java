 ...
 * 
 */
public class ICloudAuthenticate implements Authenticate<Object> {
	 ...
	 *            - the icloud apple id
	 */
	public ICloudAuthenticate(String username, String password, String icloudAppleId) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof ICloudAuthenticate))
			return false;
		ICloudAuthenticate other = (ICloudAuthenticate) obj;
