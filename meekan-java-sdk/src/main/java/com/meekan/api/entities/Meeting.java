...
public class Meeting implements MeekanEntity {
	...
	public String toString() {
		return "Meeting [timezone=" + timezone + ", last_update=" + last_update + ", invitees=" + invitees + ", votes=" + votes
				+ ", reminder_method=" + reminder_method + ", time_desc=" + time_desc + ", organizer_user=" + organizer_user
				+ ", remote_tentative_ids=" + remote_tentative_ids + ", organizer_email=" + organizer_email + ", repeat_interval=" + repeat_interval
				+ ", options=" + options + ", id=" + id + ", duration=" + duration + ", organizer=" + organizer + ", name=" + name + ", is_deleted="
				+ is_deleted + "]";
	}
